...
def get_salary_calculation_by_id(calculation_id: str) -> Optional[
  Dict[str, Any]]:
...
def update_user_settings(settings: schemas.UserSettings) -> Dict[str, Any]:
  ...
  item = {
    ...
    "target_vacation_weeks": float_to_decimal(settings.target_vacation_weeks),
